...
<link rel="stylesheet"
href="{{ asset('css/libs/jquery-ui.min.css') }}">
<link rel="stylesheet"
href="{{ asset('css/libs/jquery.dataTables.min.css') }}"/>
<link rel="stylesheet"
href="{{ asset('css/libs/select.dataTables.min.css') }}"/>
<link rel="stylesheet"
href="{{ asset('css/libs/buttons.dataTables.min.css') }}"/>

<link href="{{ url('adminlte/plugins/datetimepicker/bootstrap-datetimepicker.min.css') }}" rel="stylesheet"/>
<link rel="stylesheet" href="{{ asset('css/libs/bootstrap-datepicker3.standalone.min.css') }}" />
