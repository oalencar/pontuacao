        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::text('goal', old('goal'), ['class' => 'form-control score-mask', 'placeholder' => 'Pontuação a ser atingida', 'required' => '']) !!}
                ...
                <div class="col-xs-12 form-group">
                    ...
                    <select name="partner_type_id[]" id="partner_type_id" required class="form-control select2" multiple="multiple">
                        ...
                        @foreach($partner_types as $key => $partnerType)
                            <option value="{{ $partnerType->id }}" {{  $partnerTypesArwards->contains('id', $partnerType->id) ? 'selected' : '' }}>{{ $partnerType->getFullDescription() }}</option>
                        @endforeach
                    </select>

                    <p class="help-block">Vincula premiação tipos de parceiros</p>
