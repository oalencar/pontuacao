...
@section('content')
    ...
    {!! Form::model($premiacao, ['method' => 'PUT', 'route' => ['admin.premiacaos.update', $premiacao->id], 'files' => true,]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('title', trans('quickadmin.premiacao.fields.title').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('description', trans('quickadmin.premiacao.fields.description').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('goal', trans('quickadmin.premiacao.fields.goal').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('start_date', trans('quickadmin.premiacao.fields.start-date').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('finish_date', trans('quickadmin.premiacao.fields.finish-date').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    @if ($premiacao->image)
                        <a href="{{ asset(env('UPLOAD_PATH').'/'.$premiacao->image) }}" target="_blank"><img src="{{ asset(env('UPLOAD_PATH').'/thumb/'.$premiacao->image) }}"></a>
                    @endif
                    {!! Form::label('image', trans('quickadmin.premiacao.fields.image').'', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('partner_type_id', trans('quickadmin.premiacao.fields.partner-type').'*', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('company_id', trans('quickadmin.premiacao.fields.company').'', ['class' => 'control-label']) !!}
